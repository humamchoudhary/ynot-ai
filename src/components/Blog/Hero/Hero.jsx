...
const Hero = () => {
  return (
    <div className="hero flex main-marg">
      ...
      <h1 className="text-light font-extrabold z-20  relative my-auto text-7xl">
        The Ultimate Blogs for
        <br />
        <span className="font-medium highlight">Artificial Intelligence</span>
      </h1>
    </div>
  );
};
